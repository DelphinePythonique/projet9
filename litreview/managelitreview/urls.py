...
urlpatterns = [
    ...
    path('tickets/reviews/<int:review_id>/edit', views.update_review_with_ticket, name='update_review'),
    path('tickets/reviews/<int:review_id>/delete', views.delete_review, name='delete_review'),
    path('tickets/reviews/<int:review_id>', views.display_review, name='display_review'),
    path('tickets/<int:ticket_id>/reviews/new', views.create_review, name='create_review'),
